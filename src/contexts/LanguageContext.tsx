...
const translations = {
  en: {
    ...
    // Hero Section
    'hero.title': 'Plan Your Umrah Journey',
    'hero.subtitle': 'A blessed journey of faith and devotion',
    'hero.cta': 'Start Your Request',
    
    // About Section
    'about.title': 'About Umrah Pilgrimage',
    'about.subtitle': 'Your trusted partner for spiritual journeys',
    'about.whoWeAre': 'Who We Are',
    'about.whoWeAreDesc': 'We are a leading Umrah travel agency dedicated to serving pilgrims with excellence and devotion. With over 15 years of experience, we have helped thousands of Muslims fulfill their spiritual dreams of visiting the holy cities of Mecca and Medina. Our team of experienced professionals ensures every aspect of your journey is handled with care, from visa processing to spiritual guidance.',
    'about.description': 'Umrah is a sacred pilgrimage to Mecca that can be performed at any time of the year, unlike Hajj which has specific dates. It includes several beautiful rituals including Tawaf (circumambulation of the Kaaba seven times) and Sa\'i (walking between the hills of Safa and Marwa). While not obligatory like Hajj, Umrah is highly recommended and holds immense spiritual value.',
    'about.spiritual': 'This spiritual journey brings Muslims closer to Allah and provides a profound opportunity for prayer, reflection, repentance, and seeking forgiveness. It is a chance to cleanse the soul, renew faith, and experience the blessed atmosphere of Islam\'s holiest sites.',
    'about.feature1.title': 'Experienced Guidance',
    'about.feature1.desc': 'Our knowledgeable guides provide spiritual and practical support throughout your journey, ensuring you perform all rituals correctly while deepening your understanding.',
    'about.feature2.title': 'Premium Services',
    'about.feature2.desc': 'From luxury accommodations near the Haram to comfortable transportation, we offer premium services tailored to make your pilgrimage comfortable and memorable.',
    'about.feature3.title': 'Complete Care',
    'about.feature3.desc': 'We handle every detail from visa processing to guided ziyarat tours, allowing you to focus entirely on your spiritual experience and worship.',
    ...
    'program.payment': 'Easy payment',
    'program.hotels': 'Hotels in Medina & Mecca',
    'program.transport': 'Private Transport',
    ...
    'form.step3.tip': 'Flexible dates often result in significant cost savings. The most popular time for Umrah is during Ramadan and school holidays, so consider traveling during quieter periods for a more peaceful experience.',
    'form.step4': 'Services',
    'form.step4.title': 'Service Selection',
    'form.step4.subtitle': 'Choose the services you need for your Umrah journey',
    ...
    'form.step7.submitRequest': 'Submit Umrah Request',
    'form.step7.submittingRequest': 'Submitting Your Request...',
    'form.step7.reviewNote': 'Our team will review your request and contact you within 72 hours with a detailed quotation',
  ...
  ar: {
    ...
    'about.subtitle': 'شريكك الموثوق للرحلات الروحانية',
    'about.whoWeAre': 'من نحن',
    'about.whoWeAreDesc': 'نحن وكالة سفر رائدة متخصصة في تنظيم رحلات العمرة، ملتزمون بخدمة الحجاج بتميز وإخلاص. مع أكثر من 15 عاماً من الخبرة، ساعدنا آلاف المسلمين على تحقيق أحلامهم الروحانية بزيارة الحرمين الشريفين في مكة والمدينة. فريقنا من المحترفين ذوي الخبرة يضمن التعامل مع كل جانب من جوانب رحلتك بعناية، من معالجة التأشيرة إلى التوجيه الروحي.',
    'about.description': 'العمرة هي حج مقدس إلى مكة المكرمة يمكن أداؤها في أي وقت من السنة، على عكس الحج الذي له مواعيد محددة. تشمل عدة مناسك جميلة منها الطواف حول الكعبة المشرفة سبعة أشواط والسعي بين الصفا والمروة. وعلى الرغم من أنها ليست واجبة مثل الحج، إلا أن العمرة مستحبة بشدة ولها قيمة روحانية عظيمة.',
    'about.spiritual': 'هذه الرحلة الروحانية تقرب المسلمين من الله وتوفر فرصة عميقة للدعاء والتأمل والتوبة وطلب المغفرة. إنها فرصة لتطهير الروح وتجديد الإيمان والتجربة الروحانية في أقدس الأماكن الإسلامية.',
    'about.feature1.title': 'إرشاد متمرس',
    'about.feature1.desc': 'مرشدونا ذوو المعرفة يقدمون الدعم الروحي والعملي طوال رحلتك، مما يضمن أداء جميع المناسك بشكل صحيح مع تعميق فهمك.',
    'about.feature2.title': 'خدمات متميزة',
    'about.feature2.desc': 'من الإقامة الفاخرة بالقرب من الحرم إلى وسائل النقل المريحة، نقدم خدمات متميزة مصممة لجعل حجك مريحاً لا يُنسى.',
    'about.feature3.title': 'رعاية شاملة',
    'about.feature3.desc': 'نتعامل مع كل التفاصيل من معالجة التأشيرة إلى جولات الزيارة الموجهة، مما يتيح لك التركيز بالكامل على تجربتك الروحانية والعبادة.',
    ...
    'form.step7.reviewNote': 'سيقوم فريقنا بمراجعة طلبك والاتصال بك خلال 72 ساعة مع عرض أسعار مفصل',
  ...
  fr: {
    ...
    'about.subtitle': 'Votre partenaire de confiance pour les voyages spirituels depuis',
    'about.whoWeAre': 'Qui Sommes-Nous',
    'about.whoWeAreDesc': 'Nous sommes une agence de voyage Umrah de premier plan dédiée à servir les pèlerins avec excellence et dévotion. Avec plus de 15 ans d\'expérience, nous avons aidé des milliers de musulmans à réaliser leurs rêves spirituels de visiter les villes saintes de La Mecque et Médine. Notre équipe de professionnels expérimentés garantit que chaque aspect de votre voyage est géré avec soin, du traitement des visas aux conseils spirituels.',
    'about.description': 'L\'Umrah est un pèlerinage sacré à La Mecque qui peut être effectué à tout moment de l\'année, contrairement au Hajj qui a des dates spécifiques. Il comprend plusieurs beaux rituels dont le Tawaf (circumambulation de la Kaaba sept fois) et le Sa\'i (marche entre les collines de Safa et Marwa). Bien que non obligatoire comme le Hajj, l\'Umrah est fortement recommandée et détient une immense valeur spirituelle.',
    'about.spiritual': 'Ce voyage spirituel rapproche les musulmans d\'Allah et offre une profonde opportunité de prière, de réflexion, de repentir et de demande de pardon. C\'est une chance de purifier l\'âme, de renouveler la foi et de vivre l\'atmosphère bénie des sites les plus sacrés de l\'Islam.',
    'about.feature1.title': 'Guidance Expérimentée',
    'about.feature1.desc': 'Nos guides expérimentés fournissent un soutien spirituel et pratique tout au long de votre voyage, garantissant que vous effectuez tous les rituels correctement tout en approfondissant votre compréhension.',
    'about.feature2.title': 'Services Premium',
    'about.feature2.desc': 'Des hébergements de luxe près du Haram au transport confortable, nous offrons des services premium adaptés pour rendre votre pèlerinage confortable et mémorable.',
    'about.feature3.title': 'Soins Complets',
    'about.feature3.desc': 'Nous gérons chaque détail du traitement des visas aux visites guidées de ziyarat, vous permettant de vous concentrer entièrement sur votre expérience spirituelle et votre adoration.',
    ...
    'program.payment': 'Paiement facile',
    'program.hotels': 'Hôtels à Médine et La Mecque',
    'program.transport': 'Transport privé',
    ...
    'form.step3.tip': 'Les dates flexibles entraînent souvent des économies importantes. La période la plus populaire pour la Umrah est pendant le Ramadan et les vacances scolaires, alors considérez voyager pendant les périodes plus calmes pour une expérience plus paisible.',
    'form.step4': 'Services',
    ...
    'form.step7.reviewNote': 'Notre équipe examinera votre demande et vous contactera dans les 72 heures avec un devis détaillé',
  ...
  de: {
    ...
    'about.subtitle': 'Ihr vertrauenswürdiger Partner für spirituelle Reisen',
    'about.whoWeAre': 'Wer Wir Sind',
    'about.whoWeAreDesc': 'Wir sind ein führendes Umrah-Reisebüro, das sich der Betreuung von Pilgern mit Exzellenz und Hingabe verschrieben hat. Mit über 15 Jahren Erfahrung haben wir Tausenden von Muslimen geholfen, ihre spirituellen Träume vom Besuch der heiligen Städte Mekka und Medina zu verwirklichen. Unser Team erfahrener Fachleute stellt sicher, dass jeder Aspekt Ihrer Reise sorgfältig behandelt wird, von der Visabearbeitung bis zur spirituellen Führung.',
    'about.description': 'Umrah ist eine heilige Pilgerfahrt nach Mekka, die zu jeder Jahreszeit durchgeführt werden kann, im Gegensatz zum Hadsch, der spezifische Termine hat. Sie umfasst mehrere schöne Rituale, darunter Tawaf (siebenmaliges Umrunden der Kaaba) und Sa\'i (Gehen zwischen den Hügeln Safa und Marwa). Obwohl nicht obligatorisch wie der Hadsch, wird Umrah dringend empfohlen und hat einen immensen spirituellen Wert.',
    'about.spiritual': 'Diese spirituelle Reise bringt Muslime näher zu Allah und bietet eine tiefgreifende Gelegenheit zum Gebet, zur Reflexion, zur Reue und zur Bitte um Vergebung. Es ist eine Chance, die Seele zu reinigen, den Glauben zu erneuern und die gesegnete Atmosphäre der heiligsten Stätten des Islam zu erleben.',
    'about.feature1.title': 'Erfahrene Führung',
    'about.feature1.desc': 'Unsere sachkundigen Führer bieten während Ihrer gesamten Reise spirituelle und praktische Unterstützung und stellen sicher, dass Sie alle Rituale korrekt durchführen und Ihr Verständnis vertiefen.',
    'about.feature2.title': 'Premium-Services',
    'about.feature2.desc': 'Von luxuriösen Unterkünften in Haram-Nähe bis hin zu komfortablem Transport bieten wir Premium-Services, die darauf zugeschnitten sind, Ihre Pilgerfahrt komfortabel und unvergesslich zu machen.',
    'about.feature3.title': 'Vollständige Betreuung',
    'about.feature3.desc': 'Wir kümmern uns um jedes Detail, von der Visabearbeitung bis zu geführten Ziyarat-Touren, damit Sie sich ganz auf Ihre spirituelle Erfahrung und Anbetung konzentrieren können.',
    ...
    'program.payment': 'Einfache Zahlung',
    'program.hotels': 'Hotels in Medina und Mekka',
    'program.transport': 'Privattransport',
    ...
    'form.step7.reviewNote': 'Unser Team wird Ihre Anfrage prüfen und sich innerhalb von 72 Stunden mit einem detaillierten Angebot bei Ihnen melden',
